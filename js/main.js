...
function Place(t,e,n){
    var o=this.elm=document.createElement("div");o.className="go-place";var a=o.style;a.top=100*(t/15)+"%",a.left=100*(e/15)+"%",a.right=100-100*((e+1)/15)+"%",a.bottom=100-100*((t+1)/15)+"%",a.position="absolute";var i=document.createElement("div");if(i.className="go",o.appendChild(i),"ontouchstart"in window){var r=!1;o.ontouchstart=function(){return r=!1,!1},o.ontouchmove=function(){return r=!0,!1},o.ontouchend=function(){return r||n.clicked(t,e),r=!1,!1}}else o.onclick=function(){n.clicked(t,e)};
    o=$(o),this.elm=o,this.isSet=!1
}

function Game(t,e){
    function n(){"black"===l?o.myTurn():a.myTurn()}this.mode="hvh",this.rounds=0;var o,a,i=!1,r=[],s={},c=new Board(t,e),l="black";
    c.clicked=function(t,e){        
        var n=s[l];n instanceof HumanPlayer&&n.setGo(t,e)},this.getCurrentPlayer=function(){return s[l]},this.setCurrentColor=function(t){l=t},this.toHuman=function(t){c.setClickable(!0,t)},this.toOthers=function(){c.setClickable(!1)},this.update=function(t,e,r){i&&(this.rounds++,c.updateMap(t,e,r),a.watch(t,e,r),o.watch(t,e,r),setTimeout(n,0))},
...
function adjustSizeGen(){
    ...
    e=$("#game-region"),n=$(".board td"),o=$(".go-board"),
    a=$("header.game-ult"),i=$("#game-info"),r=$("#main-but-group"),s=$("#other-but-group");
    return function(){
        var c,l=window.innerHeight,h=window.innerWidth,
        u=Math.max(l-7,.98*l),m=Math.max(h-7,.98*h),
        f=Math.min(u-150,m),g=Math.min(m-320,u-40);
...
function showWinDialog(t){
    if(gameInfo.setBlinking(!1),"hvh"===t.mode){
        var e=function(t){return t.charAt(0).toUpperCase()+t.slice(1)}(t.getCurrentPlayer().color);
...
Player.prototype.myTurn=function(){
    ...
    gameInfo.setText(function(t){return t.charAt(0).toUpperCase()+t.slice(1)}(this.color)+"'s turn."),
...
AIPlayer.prototype.watch=function(t,e,n){this.worker.postMessage({type:"watch",r:t,c:e,color:n})},
AIPlayer.prototype.move=function(){if(0===this.game.rounds)this.setGo(7,7);else if(1===this.game.rounds)for(var t=[[6,6],[6,7],[6,8],[7,6],[7,7],[7,8],[8,6],[8,7],[8,8]];;){var e=Math.floor(Math.random()*t.length);if(this.setGo(t[e][0],t[e][1]))return;t.splice(e,1)}else this.worker.postMessage({type:"compute"})},
...
var Board=function(t,e){
    ...
    this.winChange=function(e,n,o){t.find(".warning").removeClass("warning");for(var a,i=m[o],r=0;4>r;r++)if(h[i][r][e][n]>=5){a=r;break}$(".go-place").css("opacity",.5);for(var r=-1;2>r;r+=2){var s=e,c=n;do l[s][c].elm.css("opacity",1),s+=f[a][0]*r,c+=f[a][1]*r;while(s>=0&&15>s&&c>=0&&15>c&&h[i][a][s][c]==-i)}},
    this.isSet=function(t,e){return l[t][e].isSet},
    this.getGameResult=function(t,e,n){var o=m[n];return h[o].some(function(n){return n[t][e]>4})?"win":225===g?"draw":!1},
    ...
    window.m=h,
    this.updateMap=function(t,e,n){var a=!1,i=m[n];void 0===i&&(a=!0),o(t,e,i,a)}
};
...
$(document).ready(function(){
    ...
    $('#mode-select input[type="radio"]').on("change",function(){AUD.move();gameData.mode=$(this).val();}),
    $('#color-select input[type="radio"]').on("change",function(){AUD.move();gameData.color=$(this).val()}),
    $('#level-select input[type="radio"]').on("change",function(){AUD.move();gameData.level=$(this).val()}),
    $(".back-to-game").on("tap",function(){AUD.move();$.mobile.changePage("#game-page")}),
    $("#start-game").on("click",function(){AUD.move();
